...
2. 在 `backend/app/database/repositories/` 新增 `video_repository.py`、`asset_repository.py`、`subtitle_repository.py`、`chapter_repository.py`、`progress_repository.py`。
...
1. 新增 `backend/app/services/search_service.py`。
...
1. 新增 `question_service.py`。
2. 新增 `VideoQuestionRequest`、`VideoQuestionAnswer`、`QuestionCitation` schema。
